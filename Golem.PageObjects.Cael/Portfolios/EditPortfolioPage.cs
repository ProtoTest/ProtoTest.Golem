...
namespace Golem.PageObjects.Cael.Setup_Portfolio
{
    public class EditPortfolioPage : BasePageObject
    {
        ...
        public Element SaveChanges_Button = new Element("SaveChanges_Button", By.XPath("//button[text()='Save Changes']"));
        ...
        public Element SupportFileCaption_Field = new Element("LinkUrl Field", By.Name("course_description_link"));
        ...
        public EditPortfolioPage EnterSupportDocument(string url, string caption, string descrtiption)
        {
            ...
            driver.FindVisibleElement(By.XPath("//button[text()='Save']")).Click();
            return this;
        }

        public EditPortfolioPage EditOutcomesText(string text)
        {
            driver.SwitchTo().Frame(driver.FindElement(By.XPath("//iframe"))).FindElement(By.TagName("body")).SendKeys(text);
