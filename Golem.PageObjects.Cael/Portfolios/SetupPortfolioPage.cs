...
namespace Golem.PageObjects.Cael.Setup_Portfolio
{
    public class SetupPortfolioPage : BasePageObject
    {
        ...
        public Element Region_Dropdown = new Element("Region_Dropdown", By.Id("regionDDList"));
        public Element Category_Dropdown = new Element("Category_Dropdown", By.Id("categoryDDList"));
        public Element SubCategory_Dropdown = new Element("SubCategory_Dropdown", By.Id("subcategoryDDList"));
