...
#pragma warning restore 67
        ...
        private void AfterTest_AssertNoVerificationErrors(GolemEventArgs e)
        {
        ...
        public void AfterTest_QuitBrowser(GolemEventArgs e)
        {
        ...
        public void AfterTest_LogActions(GolemEventArgs e)
        {
        ...
        public void AfterTest_StopVideoRecording(GolemEventArgs e)
        {
            try
            {
                if (Config.Settings.reportSettings.videoRecordingOnError)
        ...
        private void AfterTest_GetHTTPTrafficInfo(GolemEventArgs e)
        {
            if (Config.Settings.httpProxy.startProxy)
            {
        ...
        private void AfterTest_QuitProxy(GolemEventArgs e)
        {
            if (Config.Settings.httpProxy.startProxy)
            {
        ...
        public void Initialize()
        {
            ...
            AfterTestEvent +=  AfterTest_StopVideoRecording;
            ...
            AfterTestEvent += AfterTest_QuitBrowser;
            AfterTestEvent += AfterTest_QuitProxy;
            AfterTestEvent += AfterTest_LogActions;
            AfterTestEvent += AfterTest_GetHTTPTrafficInfo;
            AfterTestEvent += AfterTest_AssertNoVerificationErrors;
