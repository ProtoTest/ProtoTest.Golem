...
namespace ProtoTest.Golem.White
{
    public class ElementImageComparer
    {
        ...
        public IWhiteElement element;

        public ElementImageComparer(IWhiteElement element)
        {
        ...
        private string ImageLocation
        {
            get
            {
                return Directory.GetCurrentDirectory().Replace(@"\bin\Debug", "").Replace(@"\bin\Release", "") + "\\ElementImages\\" + element.description.Replace(" ", "") + ".bmp";
            }
        }
        ...
        {
            return element.getItem().GetImage();
        }
