...
{
    public class WhiteTable : Table, IWhiteElement
    {
        ...
        public WhiteTable(SearchCriteria criteria, UIItem parent = null, string description=null)
        {
        ...
        public override TableRows FindAll(string column, string value)
        {
            return item.FindAll(column, value);
        }
        ...
        public override TableRow Row(string column, string value)
        {
