...
namespace ProtoTest.Golem.Rest.OAuth
{
    ...
    public static class OAuth_Token_Keeper
    {
        ...
        {
            var populated = false;
            if (oauth_token != null && oauth_token_secret != null && oauth_consumer_key != null &&
                oauth_consumer_secret != null && oauth_signature_method != null && resource_url != null &&
                oauth_version != null)
            {
                populated = true;
            }
    ...
    public class OAuth_Request_Builder
    {
        ...
        private void BuildBaseString(string parameters)
        {
            ...
            baseString = string.Concat(http_verb + "&", Uri.EscapeDataString(resource_URL), "&",
        ...
        private string compositeKey()
        {
            ...
            {
                key = string.Concat(Uri.EscapeDataString(OAuth_Token_Keeper.oauth_consumer_secret), "&",
                    Uri.EscapeDataString(OAuth_Token_Keeper.oauth_token_secret));
            }
            else
            {
